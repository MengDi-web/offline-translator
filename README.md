...
> **系统要求**：macOS 版仅支持 **Apple 芯片（M1/M2/M3/M4）+ macOS 11 及以上**；Windows 版支持 **Windows 10/11 x64**（非中文系统控制台可能显示乱码，功能不受影响）。
...
**Windows 使用**：双击 `windows\启动翻译器.bat` → 浏览器地址栏输入 `http://127.0.0.1:6688`（详见 [windows/安装说明.md](windows/安装说明.md)）。
